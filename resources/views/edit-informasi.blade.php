...
@section('content')
    <div class="flex flex-col space-y-7">
        <div class="hidden md:block text-2xl">Ubah Informasi Sekolah</div>
                ...
                <div class="shadow sm:rounded-md sm:overflow-hidden">
                    <div class="px-4 py-5 bg-white space-y-6 sm:p-6">
                        <div>
                            ...
                            <input type="text" name="jdl_informasi" id="judul"
                                class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md"
                                required value="{{ $informasi->jdl_informasi }}">
                        </div>
                        ...
                        <div class="col-span-6 sm:col-span-3">
                            ...
                            <select id="status" name="status"
                                ...
                                <option {{ $informasi->status == 0 ? 'selected' : '' }} value="0">Tidak Aktif</option>
                                <option {{ $informasi->status == 1 ? 'selected' : '' }} value="1">Aktif</option>
                            </select>
                        </div>
                        <div>
